...
import Example from './fs'

const steps = [
  { id: '01', name: 'Connect Wallet', description: 'Connect your wallet to our system.', href: '#', status: 'complete' },
  { id: '02', name: 'Give your consent', description: 'So we can analyze your transactions.', href: '#', status: 'current' },
  { id: '03', name: 'Generate report', description: 'Get a report generated.', href: '#', status: 'current' },
]
...
export default function Check() {
  return (
    <div className="lg:border-t lg:border-b lg:border-gray-200"><br/>
