    ...
    <div className="py-12 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          <h2 className="text-base text-indigo-600 font-semibold tracking-wide uppercase">Give your consent</h2>
          <p className="mt-2 text-3xl leading-8 font-bold tracking-tight text-gray-900 sm:text-4xl">
            Please approve our smart contract to indicate your consent.
          </p>
          <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
            We are in compliance with European GDPR Data Privacy Laws, so we require you to sign a smart contract call which gives your consent for us to analyze your transactions.
          </p>
          <p className="mt-4 max-w-2xl text-sm text-gray-500 lg:mx-auto">
            Please note this process is mandated by law and is completely free, you just have to pay the Ethereum network gas fees determined by your wallet.
          </p>
        </div>

        <div className="mt-10">
          <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
            <button onClick={approve} className="block w-full rounded-md border border-transparent px-5 py-3 bg-indigo-600 text-base font-medium text-white shadow hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:px-10">Approve</button>
          </dl>
        </div>
      </div>
    </div>
